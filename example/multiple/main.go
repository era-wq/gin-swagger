...
import (
	...
	v1 "github.com/era-wq/gin-swagger/example/multiple/api/v1"
	v2 "github.com/era-wq/gin-swagger/example/multiple/api/v2"
	_ "github.com/era-wq/gin-swagger/example/multiple/docs"

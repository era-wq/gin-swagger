...
[![Build Status](https://github.com/era-wq/gin-swagger/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/era-wq/gin-swagger)](https://goreportcard.com/report/github.com/era-wq/gin-swagger)
[![GoDoc](https://godoc.org/github.com/era-wq/gin-swagger?status.svg)](https://godoc.org/github.com/era-wq/gin-swagger)
[![Release](https://img.shields.io/github/release/swaggo/gin-swagger.svg?style=flat-square)](https://github.com/era-wq/gin-swagger/releases)
...
4. Download [gin-swagger](https://github.com/era-wq/gin-swagger) by using:

```sh
go get -u github.com/era-wq/gin-swagger
...
```go
import "github.com/era-wq/gin-swagger" // gin-swagger middleware
...
import (
   ...
   ginSwagger "github.com/era-wq/gin-swagger"
   "net/http"
)
// @BasePath /api/v1
